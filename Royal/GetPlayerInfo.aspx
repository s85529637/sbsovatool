<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="SovaMasterPage.master"
    MaintainScrollPositionOnPostback="true" Inherits="GetLockedPlayer" CodeFile="GetPlayerInfo.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <asp:Button ID="btnPowerReturnAccount" runat="server" Text="強制解鎖會員(請白馬確認該會員無帳務紀錄才能使用此功能)" OnClick="btnPowerReturnAccount_Click" Visible="False" OnClientClick="return confirm('確定該會員無帳務紀錄？');" ForeColor="Red" />
    <br />
