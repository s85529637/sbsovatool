...
public partial class ManualReturnJumbo : NewBasePage
{
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = bssql.ManualReturnAccount_Jumbo(txtClubEname.Text.Trim(),"");
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            String sJumboStatus = (String.IsNullOrEmpty(r["JumboStatus"].ToString())) ? "0" : r["JumboStatus"].ToString();
            String sSovaCount = (String.IsNullOrEmpty(r["SovaCount"].ToString())) ? "0" : r["SovaCount"].ToString();
            String sJumboCount = (String.IsNullOrEmpty(r["JumboCount"].ToString())) ? "0" : r["JumboCount"].ToString();
            ...
            int iJumboStatus = int.Parse(sJumboStatus);
            int iSovaCount = int.Parse(sSovaCount);
            int iJumboCount = int.Parse(sJumboCount);
